...
function renderIngredientsBoard(){
  document.querySelector(".item1").style.visibility=state.Patty?"visible":"hidden";
  document.querySelector(".item2").style.visibility=state.Cheese?"visible":"hidden";
  document.querySelector(".item3").style.visibility=state.Tomatoes?"visible":"hidden";
  document.querySelector(".item4").style.visibility=state.Onions?"visible":"hidden";
  document.querySelector(".item5").style.visibility=state.Lettuce?"visible":"hidden";
}
